...
configatron.newgistics do |newgistics|
  ...
  newgistics.uri = ENV['NEWGISTICS_URI']
...
configatron.fame_webclient_always_regex = /^(\/static|\/contact|\/product|\/iequalchange|\/faq|\/collection|\/dresses|\/_webclient|\/custom-clothes|\/dress-system|\/search|\/pants|\/jackets|\/outerwear|\/jumpsuits|\/gowns|\/skirts|\/tops|\/size-guide|\/bride|\/about|\/privacy|\/terms|\/wholesale|\/clothing|\/cart|\/orders(\/)?$|\/return((?!s).)[^\/]*|\/$)/
