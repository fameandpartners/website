...
configatron.fame_webclient_always_regex = /^(\/static|\/dresses-new)/
configatron.fame_webclient_regex = /^(\/bridesmaids-swatches|\/bridesmaids-search|\/dresses\/(custom-dress|dress-.*-[0-9]*))/
