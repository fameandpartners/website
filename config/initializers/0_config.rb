...
configatron.fame_webclient_always_regex = /^(\/static|\/dresses-new|\/_webclient|\/dress-system|\/dresses\/custom-dress-FPG|\/dresses\/dress-FPG)/
configatron.fame_webclient_regex = /^(\/size-guide|\/dresses\/(custom-dress|dress-.*-[0-9]*))/
