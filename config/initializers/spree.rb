...
Spree.config do |config|
  ...
  config.allow_ssl_in_development_and_test = ENV.fetch('SPREE_SSL_IN_DEVELOPMENT'){ 'true' } == 'true'?Features.active?(:force_sitewide_ssl):false
  puts "config.allow_ssl_in_development_and_test: " + config.allow_ssl_in_development_and_test.to_s
