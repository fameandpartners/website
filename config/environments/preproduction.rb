FameAndPartners::Application.configure do
  ...
  config.assets.precompile += %w( application_redesign.js application_redesign.css main_nav_widget.css  html5.js ie.css widgets/site_navigations.css widgets/site_navigations.js )
