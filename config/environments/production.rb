FameAndPartners::Application.configure do
  ...
  config.assets.precompile += %w( storefront.js application_redesign.css main_nav_widget.css html5.js ie.css widgets/site_navigations.css quiz.css quiz.js application_contentful.css application_contentful.js application_returns.js application_returns.css application_returns.js application_returns.css application_custom_experience.js application_custom_experience.css)
