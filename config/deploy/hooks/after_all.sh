...
-X POST \
--data-urlencode "payload={'channel':'#dev-robots','username':'FameBot','icon_emoji':':dancer:','text':'*Sentinel* started deploying ${git_revision_tag} to *${SERVER_ROLE} ${FRAMEWORK_ENV}*'}"
