...
-X POST \
--data-urlencode "payload={\"channel\":\"#dev-robots\",\"username\":\"FameBot\",\"icon_emoji\":\":dancer:\",\"text\":\"Deploying new version: *${git_branch}*/*${remote_sha}* to *${SERVER_ROLE} ${FRAMEWORK_ENV}*\"}"
