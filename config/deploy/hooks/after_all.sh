...
-X POST \
--data-urlencode "payload={\"channel\":\"#dev-robots\",\"username\":\"FameBot\",\"icon_emoji\":\":dancer:\",\"text\":\"Deploying new version to *${SERVER_ROLE} ${FRAMEWORK_ENV}* - *${git_branch}* - (${remote_sha})\"}"
