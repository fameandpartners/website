...
// Sidebar within 2col desktop
const CollectionSidebarApp = () => {
  return (
...
// Nodes for Mounting
const sidebarNode = document.getElementById('js-CollectionSidebarApp');
...
// Mounting of Nodes
if (sidebarNode){ RD.render(CollectionSidebarApp(), sidebarNode); }
