$('.checkout.edit').ready ->
  ...
  window.fill = () ->
    ...
    $('#order_ship_address_attributes_country_id').val(49)
    $('#order_ship_address_attributes_state_id').val(23)
    $('#order_ship_address_attributes_zipcode').val(123456)
    $('#order_ship_address_attributes_phone').val('0123456789')
    
    # card tab
    $('#payment_source_1_number').val('4111111111111111')
    $('#payment_source_1_full_name').val('NotJohn NotSmith')
    $('#payment_source_1_year').val(2015)
    $('#card_code').val(123)
