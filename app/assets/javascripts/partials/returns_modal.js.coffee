...
window.page.ReturnsOptimizelyModal = class ReturnsOptimizelyModal extends CheckoutModal
  constructor: (opts = {}) ->
    if (opts == 'A')
      ...
      modalCheckboxWrapper = '<div class="row js-returns-abc-option-A">'
      modalCheckbox = $('.js-returns-abc-option-A').html()
    else
      ...
      modalCheckboxWrapper = '<div class="row js-returns-abc-option-B">'
      modalCheckbox = $('.js-returns-abc-option-B').html()
