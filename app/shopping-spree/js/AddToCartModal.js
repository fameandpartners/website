  ...
  sumCartData(snapshot) {
    ...
    this.createFamebotMessage(
      this.props.name +
        ...
        " to their cart.  You are now getting " +
        this.calculateDiscount({ totalItems: count }) +
        "% off",
      "discount",
    );
  }
        ...
        <div className="shopping-spree-cart-modal shopping-spree">
          ...
          <div>
            <div
              ...
              className="text-center shopping-spree-big-headline"
            >
              Add to your cart!
            </div>
          </div>
          ...
          <div className="height-selection-wrapper clearfix u-mb--normal">
            <div className="height-select-text">
              <div className="col-xs-12">What's your Height?</div>
            </div>

            <div className="select-dress-size">
              <div className="col-xs-8 col-md-6">
                <select
                  onChange={this.heightSelected}
                  className={
                    this.state.showHeightError
                      ? "height-select red-border"
                      : "height-select"
                  }
                >
              ...
              {this.state.showHeightError && (
                <div>
                  <div className="col-xs-12 shopping-spree-error">
          ...
          <div className="height-select-text clearfix">
            <div className="col-xs-12">What's Your Dress Size?</div>
          </div>
