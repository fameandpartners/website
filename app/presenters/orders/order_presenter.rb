      ...
      self.line_items.collect do |item|
        {
          ...
          sku:                   item.sku,
          extended_style_number: item.item.new_sku,
          ...
          express_making:        item.making_options.present? ? item.making_options.map { |option| option.product_making_option.making_option.name.upcase }.join(', ') : "",
