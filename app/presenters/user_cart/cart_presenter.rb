  ...
  def serialize
    {
      ...
      display_item_total_cent: display_item_total&.money&.fractional || 0,
      ...
      display_promotion_total_cent: display_promotion_total&.money&.fractional || 0,
      display_total: display_total.to_s,
      display_total_cent: display_total&.money&.fractional || 0,
      taxes: taxes,
      delivery_delay: Features.active?(:cny_delivery_delays),
      delivery_discount: "$#{('%.2f' %((display_item_total&.money&.fractional&.to_f || 0)/1000).round(2)).to_s}"
    }
  end
end
