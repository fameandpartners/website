Spree::Promotion.class_eval do
  ...
  protected
    ...
    def can_apply_to_any_order?
      %w(xtra10 swm30 is20 who20 fam20 btb20p btb20d gf20 theparcel25 frenzy5p crafted4u vosn2015 famer35p zouponsfame famexinstyle5 ibotta5 famexAU5 famexUS5 bonus5p birthday5p).include?(self.code.downcase)
    end
