...
#  end
  ...
  def set_session_for_redeem_via_fb_state_and_send_customerio_event(email)
    if session[:redeem_via_fb_state] == 'clicked'
  ...
  def facebook
    ...
    if authentication.present?
      ...
      set_session_for_redeem_via_fb_state_and_send_customerio_event(authentication.user.email)
      ...
      set_session_for_redeem_via_fb_state_and_send_customerio_event(spree_current_user.email)
      ...
      if user.save
        ...
        set_session_for_redeem_via_fb_state_and_send_customerio_event(user.email)
