class MoodboardCommentsController < ApplicationController
  ...
  # GET /MoodboardComments/new
  # GET /MoodboardComments/new.json
  def new
    moodboard_comment = MoodboardComment.new

    respond_to do |format|
      format.html # new.html.erb
      format.json { render json: moodboard_comment }
    end
  end

  # GET /MoodboardComments/1/edit
  def edit
