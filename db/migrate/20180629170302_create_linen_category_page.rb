class CreateLinenCategoryPage < ActiveRecord::Migration
# All values MUST be Strings!
  private def landing_page_properties
    {
      path:                 '/shop-linen',
      template_path:        '/products/collections/show',
      heading:              'Linen Dresses & Jumpsuits',
      title:                'Custom-Made Linen Dresses & Jumpsuits',
      meta_description:     'Shop linen dresses and linen jumpsuits for summer, all customizable and ethically made-to-order.',
      curated:              'true',
      lookbook:             'true',
