class UpdateTermPage < ActiveRecord::Migration
  def up
    page = Revolution::Page.where(path: "/terms").first
...
* Store Credit may not be purchased and is only provided when purchased items have been returned and you have selected "Store Credit" as the refund method or more than 2 items from an order are being returned or exchanged.
