class UpdateQuiz < ActiveRecord::Migration
  def up
    ...
    q1.update_columns(position: "1002", step: 2)
    q2.update_columns(position: "1001", step: 1)
    q3.update_columns(position: "1004", step: 4)
    q4.update_columns(position: "1005", step: 5)
    q5.update_columns(position: "1006", step: 6)
    q6.update_columns(position: "1007", step: 7)
    q7.update_columns(position: "1008", step: 8)
    q8.update_columns(position: "1009", step: 9)
    q9.update_columns(position: "1010", step: 10)
    q10.update_columns(position: "1011", step: 10)
    q11.update_columns(position: "1012", step: 11)
