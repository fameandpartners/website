class CreateDressesForPartiesLandingPage < ActiveRecord::Migration
  ...
  DRESS_FOR_PARTIES_PIDS = %w(1054-ivory 283-white 262-white 345-white 1060-ivory 1049-ivory 1008-white 1009-ivory 1064-blush 1096-light-nude 1106-mushroom 635-peach 861-pale-grey 997-pale-blue 840-navy 582-navy
  ...
  def up
    unless Revolution::Page.where(path: DRESS_FOR_PARTIES_PATH).exists?
      page = Revolution::Page.create!(
        ...
        variables:     { lookbook: true, pids: DRESS_FOR_PARTIES_PIDS },
