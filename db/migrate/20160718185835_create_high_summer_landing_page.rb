  ...
  def up
    if Revolution::Page.where(path: "/brittany-xavier-high-summer-collection").first.nil?
      page = Revolution::Page.create!(
        ...
        :variables => {:publish_from => 1.day.ago, :lookbook => true, :limit => 9, :pids => ["1090-white", "1086-pale-blue-cotton-stripe", "1082-navy", "1071-pale-blue", "1068-white", "1061-looking-glass", "1054-black", "1040-black", "1030-dark-burgundy"] }
      )
