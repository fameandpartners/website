            ...
            <div className="moodboard-tabs center-block">
              <ul className="nav nav-tabs center-block" role="tablist">
                ...
                <li className="active" role="presentation">
                  <a aria-controls="bridesmaid-dresses" data-toggle="tab" href="#bridesmaid-dresses" role="tab" id="bridesmaid-dresses-tab" title="View your dresses" data-content="Create new looks and vote on your favorites" data-placement="bottom">
                    Bridesmaid dresses</a>
                </li>
                <li role="presentation">
                  <a aria-controls="wedding-details" data-toggle="tab" href="#wedding-details" role="tab" id="wedding-details-tab" title="Update the details" data-content="Input everything you need to know about the big day" data-placement="bottom">
                  Wedding details</a>
                </li>
                <li role="presentation">
                  <a aria-controls="manage-bridal-party" data-toggle="tab" href="#manage-bridal-party" role="tab" id="manage-bridal-party-tab" title="Manage the group" data-content="Add, view, and remove members of the bridal party" data-placement="bottom">
                  Bridal party</a>
                </li>
