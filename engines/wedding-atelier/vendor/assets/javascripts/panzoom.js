	...
	Panzoom.prototype = {
		...
		_startMove: function(event, touches) {
			...
			var setStart = function(event, touches) {
				...
				startPageX = event.pageX || event.originalEvent.pageX;
				startPageY = event.pageY || event.originalEvent.pageY;
			};
        ...
        coordsX = coords.pageX || coords.originalEvent.pageX;
        coordsY = coords.pageY || coords.originalEvent.pageY;

				self.pan(
					origPageX + coordsX - startPageX,
					origPageY + coordsY - startPageY,
					panOptions
				);
			};
