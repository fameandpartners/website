  ...
  class ColorVariantsIndexer
    ...
    def map_product(index_name, id, product, fabric, color, product_fabric_value, product_color_value)
      ...
      if product_fabric_value
        fabric_price_in_us = product_fabric_value.price_in(@us_site_version.currency) : 0
        fabric_price_in_au = product_fabric_value.price_in(@au_site_version.currency) : 0
