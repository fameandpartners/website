...
Gem::Specification.new do |s|
  ...
  s.summary = "rspec-rails-3.2.1".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activesupport>.freeze, ["< 4.3", ">= 3.0"])
      s.add_runtime_dependency(%q<actionpack>.freeze, ["< 4.3", ">= 3.0"])
      s.add_runtime_dependency(%q<railties>.freeze, ["< 4.3", ">= 3.0"])
      s.add_runtime_dependency(%q<rspec-core>.freeze, ["~> 3.2.0"])
      s.add_runtime_dependency(%q<rspec-expectations>.freeze, ["~> 3.2.0"])
      s.add_runtime_dependency(%q<rspec-mocks>.freeze, ["~> 3.2.0"])
      s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.2.0"])
      ...
      s.add_dependency(%q<activesupport>.freeze, ["< 4.3", ">= 3.0"])
      s.add_dependency(%q<actionpack>.freeze, ["< 4.3", ">= 3.0"])
      s.add_dependency(%q<railties>.freeze, ["< 4.3", ">= 3.0"])
      s.add_dependency(%q<rspec-core>.freeze, ["~> 3.2.0"])
      s.add_dependency(%q<rspec-expectations>.freeze, ["~> 3.2.0"])
      s.add_dependency(%q<rspec-mocks>.freeze, ["~> 3.2.0"])
      s.add_dependency(%q<rspec-support>.freeze, ["~> 3.2.0"])
