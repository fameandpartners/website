# -*- encoding: utf-8 -*-
# stub: capybara-screenshot 1.0.14 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.rubyforge_project = "capybara-screenshot".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<capybara>.freeze, ["< 3", ">= 1.0"])
      ...
      s.add_dependency(%q<capybara>.freeze, ["< 3", ">= 1.0"])
