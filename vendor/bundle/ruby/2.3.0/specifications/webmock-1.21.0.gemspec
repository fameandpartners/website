...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<http>.freeze, [">= 0.6.0"])
      ...
      s.add_development_dependency(%q<curb>.freeze, ["<= 0.8.6"])
      ...
      s.add_dependency(%q<http>.freeze, [">= 0.6.0"])
      ...
      s.add_dependency(%q<curb>.freeze, ["<= 0.8.6"])
