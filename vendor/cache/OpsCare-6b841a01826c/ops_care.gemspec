...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<okcomputer>, ["~> 1"])
      s.add_runtime_dependency(%q<bugsnag>, ["~> 2"])
      s.add_runtime_dependency(%q<logstasher>, ["~> 0"])
      s.add_development_dependency(%q<bundler>, ["~> 1"])
      s.add_development_dependency(%q<rake>, ["~> 10.0"])
    else
      s.add_dependency(%q<skylight>, ["~> 0"])
      s.add_dependency(%q<okcomputer>, ["~> 1"])
      s.add_dependency(%q<bugsnag>, ["~> 2"])
      s.add_dependency(%q<logstasher>, ["~> 0"])
