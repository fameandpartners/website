# -*- encoding: utf-8 -*-
# stub: spree_auth_devise 1.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<selenium-webdriver>, ["= 2.34.0"])
      ...
      s.add_dependency(%q<selenium-webdriver>, ["= 2.34.0"])
