    ...
    context 'Bergen API versions' do
      ...
      describe 'staging' do
        it 'correctly loads wsdl methods' do
          expect(service.client.wsdl.soap_actions).to match_array(known_staging_methods)
        end
      ...
      describe 'production' do
        ...
        it 'correctly loads wsdl methods' do
          expect(service.client.wsdl.soap_actions).to match_array(known_production_methods)
        end
