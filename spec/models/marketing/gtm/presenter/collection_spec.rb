  ...
  module Gtm
    module Presenter
      describe Collection, type: :presenter do
        ...
        let(:super_dress) { build_stubbed(:dress, id: 123, sku: 'SUPERSKU', variants: [first_variant], name: 'Super Dress') }
        let(:jedi_cosplay) { build_stubbed(:dress, id: 456, sku: 'JEDISKU', variants: [second_variant], name: 'Jedi Cosplay') }
