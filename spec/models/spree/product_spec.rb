...
describe Spree::Product, :type => :model do
  ...
  describe '#minimum_delivery_period' do
    ...
    it "returns minimum delivery period from taxons" do
      subject.taxons << FactoryGirl.create(:taxon, delivery_period: '14 - 28 business days')
      expect(subject.minimum_delivery_period).to eq('14 - 28 business days')

      subject.taxons << FactoryGirl.create(:taxon, delivery_period: '10 - 14 business days')
